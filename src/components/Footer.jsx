    ...
    <footer className="bg-secondary text-light  boTTom " >
      <Container className='foNt'  >
        ...
        <Col sm="3" className='mt-4' >
            <h5 className='pb-3'>Media Palta</h5>
            <p>Los ofrecemos productos de Excelente Calidad</p>
        
          </Col>
          <Col sm="3" className='mt-4'>
            <h5 className='pb-3'>Categorias</h5>
          ...
          <Col sm="3" className='mt-4'>
          <h5 className='pb-3'>Información de contacto</h5>
            <p>Correo electrónico: mediapalta@gmail.com</p>
            <p>Teléfono: 123-456-7890</p>
          </Col>
          <Col sm="3" className='mt-4 '>
            
            <h5 className='pb-3'>Sigamos Conectados</h5>
            <Row>
              <Col>
...
<Col><a href=""><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"/>
        ...
        <Row className='mb-5 '>
           ...
           <Col sm="2"><img className='iCons' src="https://d26lpennugtm8s.cloudfront.net/assets/common/img/logos/payment/new_logos_payment/mastercard@2x.png"/></Col>
           <Col sm="2"><img className='iCons' src="https://d26lpennugtm8s.cloudfront.net/assets/common/img/logos/payment/new_logos_payment/amex@2x.png" /></Col>
